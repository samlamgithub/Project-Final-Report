...
\begin{figure}[h]
    ...
    \caption{3D reconstructed model by CHISEL}
    \label{fig: CHISEL2}
\end{figure}
...
\begin{figure}[h]
    ...
    \caption{InfiniTAM reconstructed model}
...
\end{lstlisting}
A table \ref{table:OpenGL ES adaptation} is given below to list the adapted functions of OpenGL in the original ElasticFusion program.
