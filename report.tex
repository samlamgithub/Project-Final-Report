...
In the ElasticFusion program, Eigen is used to store the position or pose data uisng Eigen structures like \textit{Eigen::Matrix4f} or \textit{Eigen::Isometry3f}
