...
glGetBufferSubData(GL_ARRAY_BUFFER, 0, count * Vertex::SIZE, vertices);
  Eigen::Vector4f *ver = (Eigen::Vector4f *)glMapBufferRange(
      ...
      glTransformFeedbackVaryingsNV glTransformFeedbackVaryings before binding
